...
namespace ChefRisingStar
{
    public partial class AppShell : Xamarin.Forms.Shell
    {
        ...
        public AppShell()
        {
            ...
            Routing.RegisterRoute(nameof(ManageAchievementStepsPage), typeof(ManageAchievementStepsPage));
            Routing.RegisterRoute(nameof(ManageAchievementsPage02), typeof(ManageAchievementsPage02));
